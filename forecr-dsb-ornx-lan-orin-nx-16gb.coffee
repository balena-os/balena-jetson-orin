...
module.exports =
	version: 1
	slug: 'forecr-dsb-ornx-lan-orin-nx-16gb'
	name: 'Forecr DSBOARD-ORNX-LAN Orin NX 16GB'
	arch: 'aarch64'
	state: 'released'
	...
	yocto:
		machine: 'forecr-dsb-ornx-lan-orin-nx-16gb'
		image: 'balena-image-flasher'
		fstype: 'balenaos-img'
		version: 'yocto-kirkstone'
		deployArtifact: 'balena-image-flasher-forecr-dsb-ornx-lan-orin-nx-16gb.balenaos-img'
		compressed: true
