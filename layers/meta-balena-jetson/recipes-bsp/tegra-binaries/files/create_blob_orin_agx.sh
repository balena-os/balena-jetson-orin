...
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=128 skip=3348 count=748

#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=4096 skip=4325376 count=144
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=4240 skip=65536000 count=15312
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=19552 skip=4330592 count=64
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=19616 skip=4333360 count=64
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=19680 skip=4728832 count=480
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=20160 skip=4732320 count=2320
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=22480 skip=4740272 count=22784
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=45264 skip=36569088 count=160
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=45424 skip=36574304 count=64
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=45488 skip=36577072 count=64
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=45552 skip=36972544 count=448
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=46000 skip=36993200 count=64
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=46064 skip=65536000 count=18112
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=64176 skip=66060288 count=32
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=64208 skip=66732016 count=8192
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=72400 skip=66846720 count=7248
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=79648 skip=66863104 count=96
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=79744 skip=66912256 count=112
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=79856 skip=66977792 count=112
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=79968 skip=67091968 count=7248
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=87216 skip=67108352 count=96
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=87312 skip=12713984 count=144
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=87456 skip=12719104 count=160
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=87616 skip=12721888 count=160
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=87776 skip=16108416 count=16
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=87792 skip=44957696 count=144
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=87936 skip=44962912 count=64
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=88000 skip=44965600 count=144
#dd if=mtd0ro.bin of=T234_devkit_patch.bin bs=1 seek=88144 skip=37006403 count=2
...
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=4325376 skip=4096 count=144 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=4330592 skip=19552 count=64 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=4333360 skip=19616 count=64 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=4728832 skip=19680 count=480 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=4732320 skip=20160 count=2320 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=4740272 skip=22480 count=22784 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=36569088 skip=45264 count=160 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=36574304 skip=45424 count=64 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=36577072 skip=45488 count=64 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=36972544 skip=45552 count=448 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=36993200 skip=46000 count=64 conv=notrunc
dd if=/dev/zero count=2 bs=1 of=boot0.img seek=37006402 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=65536000 skip=46064 count=18112 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=66060288 skip=64176 count=32 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=66732016 skip=64208 count=8192 conv=notrunc
dd if=/dev/zero count=8208 bs=1 of=boot0.img seek=66740208 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=66846720 skip=72400 count=7248 conv=notrunc
dd if=/dev/zero count=9648 bs=1 of=boot0.img seek=66853968 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=66846720 skip=72400 count=7248 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=66863104 skip=79648 count=96 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=66912256 skip=79744 count=112 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=66977792 skip=79856 count=112 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=67091968 skip=79968 count=7248 conv=notrunc
dd if=/dev/zero count=9648 bs=1 of=boot0.img seek=67099216 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=67108352 skip=87216 count=96 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=12713984 skip=87312 count=144 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=12719104 skip=87456 count=160 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=12721888 skip=87616 count=160 conv=notrunc
dd if=/dev/zero count=81920 bs=1 | tr "\000" "\377" | dd of=boot0.img seek=16108432 count=81920 bs=1 conv=notrunc
dd if=/dev/zero count=81920 bs=1 | tr "\000" "\377" | dd of=boot0.img seek=48352144 count=81920 bs=1 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=16108416 skip=87776 count=16 conv=notrunc
dd if=/dev/zero of=boot0.img count=3 bs=1 seek=37006381  conv=notrunc
echo -n -e '\x02\x03' | dd of=boot0.img seek=37006402 bs=1 conv=notrunc count=1
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=44957696 skip=87792 count=144 conv=notrunc
echo -n -e '\xab\x33' | dd of=boot0.img seek=44962821 bs=1 conv=notrunc
dd if=T234_devkit_patch.bin of=boot0.img bs=1 seek=44962912 skip=87936 count=64 conv=notrunc
