...
#bl_dtbs=("tegra234-p3768-0000+p3767-0000-nv.dtb"
...
case "${DEVICE_TYPE}" in
	...
	"jetson-orin-nano-seeed-j3010" | "jetson-orin-nx-seeed-j4012")
		...
		#cp /build_dir/Linux_for_Tegra/bootloader/tegra234-j401-p3768-0000+p3767-0004-recomputer.dtb /build_dir/Linux_for_Tegra/kernel/dtb/
		#cp /build_dir/Linux_for_Tegra/bootloader/tegra234-j401-p3768-0000+p3767-0000-recomputer.dtb /build_dir/Linux_for_Tegra/kernel/dtb/
		#cp /build_dir/Linux_for_Tegra/bootloader/tegra234-p3767-camera-p3768-imx219-dual-seeed.dtbo /build_dir/Linux_for_Tegra/kernel/dtb/

		#bl_dtbs=("tegra234-j401-p3768-0000+p3767-0004-recomputer.dtb" "tegra234-j401-p3768-0000+p3767-0000-recomputer.dtb")

		#for bl_dtb in ${bl_dtbs[@]}; do
		#	fdtput -t s /build_dir/Linux_for_Tegra/bootloader/${bl_dtb} / balenaOSCapsule "true"
		#	cp /build_dir/Linux_for_Tegra/bootloader/${bl_dtb} /build_dir/Linux_for_Tegra/kernel/dtb/
		#done
...
#for bl_dtb in ${bl_dtbs[@]}; do
#    fdtput -t s /build_dir/Linux_for_Tegra/bootloader/${bl_dtb} / balenaOSCapsule "true"
#    fdtput -t s /build_dir/Linux_for_Tegra/kernel/dtb/${bl_dtb} / balenaOSCapsule "true"
#done
