...
* Update flowzonify to 0.4.11 [balena-renovate[bot]]
...
* layers/meta-balena: Update to v6.10.26 [Alexandru Costache]

# v6.10.25
## (2026-02-10)

* layers/meta-balena: Update to v6.10.25 [Alexandru Costache]
...
* layers/meta-balena: Update to v6.6.4 [Alexandru Costache]
* tegra-binaries/uefi-capsule-container: Create package for building UEFI capsules [Alexandru Costache]
...
* balena-yocto-scripts: Update layer to v1.25.63 [Alexandru Costache]
...
* layers/meta-balena: Update to v6.0.6 [Alexandru Costache]
...
* layers/meta-balena: Update to v5.3.25 [Alexandru Costache]
